...
public class AnnotationConfig {
    ...
    public DataDemo dataDemo() {
        ...
        try {
            InputStream inputStream = AnnotationConfig.class.getClassLoader().getResourceAsStream("pro.properties");
    ...
    public DataDemo dataDemoDev() {
        Properties properties = new Properties();
        try {
            InputStream inputStream = AnnotationConfig.class.getClassLoader().getResourceAsStream("dev.properties");
            properties.load(new BufferedReader(new InputStreamReader(inputStream)));
        } catch (IOException e) {
            e.printStackTrace();
        }
